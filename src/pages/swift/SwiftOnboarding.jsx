        ...
        <Section>
          <div className="row justify-content-center">
            <div className="col-lg-7">
              <Section
                className={
                  "text-center bg-primary text-light py-5 rounded-3 mt-5"
                }
              >
                <div className="d-flex justify-content-center align-items-center mb-2">
                  <h3 className="">Welcome to Swift Partner Services!</h3>
                </div>
                <h5 className="fw-light">Swift Partner Onboarding</h5>
              </Section>
              <p className="text-center alert alert-light">
                Welcome aboard! To access our swift services, let's start by
                registering you. It's quick, easy, and the gateway to a smoother
                experience.
              </p>
              <Section>
                <div className="alert alert-warning">
                  ...
                  the prevention of money laundering, and Article 305 of the
                  Swiss Criminal Code. The nature and origin of the funds owned
                  by me or the corporate entity under my control are
                  forthrightly and honestly described and defined herein. The
                  preparer of this information sheet requests all recipients of
                  this document to affirm to protect the confidentiality of the
                  information.
                </div>
              </Section>
                ...
                <form onSubmit={handleSubmit(handleFormSubmit)}>
                  <fieldset>
                    <>
                      <div className="row mb-4 g-3">
                        ...
                        <div className="col-sm-12 col-md-12 col-lg-12">
                          ...
                          />
                          <div className="invalid-feedback">
                            {errors.federalNumber &&
                              errors.federalNumber.message}
                          </div>
                        </div>
                      </div>
                    </>
                    ...
                    <div className="alert alert-info">
                      ...
                      origin of funds is in compliance with
                      Anti-Money-Laundering Policies as set forth by the
